...
public class Auth extends HttpServlet {
    ...
    protected void doGet(
        ...
        if ("/auth/logout".equals(path)) {
            ...
            if (session != null &&
                    session.getAttribute(AppConfig.SESSION_USER) != null) {
    ...
    private void handleLogin(
        ...
        if (!isValidLoginInput(username, pass)) {
        ...
        if (user != null) {
            ...
            if ("true".equalsIgnoreCase(rememberMe)) {
                ...
                CookieUtil.applyRememberMeCookies(
                        resp,
                        user.getUsername(),
                        user.getRoleName()
                );
